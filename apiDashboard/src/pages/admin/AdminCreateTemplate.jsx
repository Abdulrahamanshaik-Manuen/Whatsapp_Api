         ...
         <div className="max-w-[1300px] mx-auto relative z-10">
            ...
            <div className="mb-6 space-y-3">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-xl md:text-2xl font-black text-primary tracking-tight">Create Template</h1>
               </div>
               {/* Row 2: Subtitle + Action */}
               <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Design and push professional Meta templates for clients</p>
                  <button
                     onClick={handleSubmit}
                     disabled={loading || !formData.name || !formData.body}
                     className="group flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-primary/90 transition-all shadow-xl shadow-primary/20 disabled:opacity-40 disabled:cursor-not-allowed active:scale-95 w-full sm:w-auto shrink-0"
                  >
                     {loading ? <Loader2 size={14} className="animate-spin text-[#25D366]" /> : <Zap size={14} className="text-[#25D366] group-hover:animate-pulse" />}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10 items-start">
               <div className="lg:col-span-8 space-y-6 md:space-y-8">
                  <div className="bg-white/80 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] border border-white shadow-[0_20px_40px_-12px_rgba(0,0,0,0.03)] p-5 sm:p-8 md:p-10 space-y-6 md:space-y-10">
               ...
               {/* Preview Side - Hidden on mobile, shown on lg+ */}
               <div className="hidden lg:flex lg:col-span-4 flex-col items-center">
