  ...
  return (
    <div className="h-full bg-[#F8FAFC] flex flex-col p-8 lg:p-12 space-y-12 overflow-y-auto custom-scrollbar">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">System <span className="text-indigo-600">Settings</span></h1>
        ...
        <div className="xl:col-span-1 space-y-3">
          ...
          <div className="mt-12 p-8 bg-slate-900 rounded-[2.5rem] text-white relative overflow-hidden">
             ...
             <div className="relative z-10 space-y-4">
                ...
                <button className="text-[10px] font-black text-indigo-400 uppercase tracking-widest hover:text-indigo-300 transition-all">Security Audit</button>
             </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex flex-col md:flex-row md:items-center gap-10">
                <div className="relative group">
                  <div className="w-32 h-32 rounded-[2.5rem] bg-indigo-50 border-4 border-white shadow-xl flex items-center justify-center text-indigo-600 relative overflow-hidden">
                    <User size={48} />
                    <div className="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                       <Smartphone size={24} className="text-white" />
                    </div>
                  </div>
                  <button className="absolute -bottom-2 -right-2 w-10 h-10 bg-indigo-600 rounded-xl text-white shadow-lg flex items-center justify-center border-4 border-white">
                    <Zap size={16} />
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                ...
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-3xl text-sm font-bold focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all" 
                  />
                </div>
                <div className="space-y-3">
              ...
              <div className="flex justify-end pt-8 border-t border-slate-50">
                <button 
                  ...
                  disabled={loading}
                  className="px-12 py-5 bg-indigo-600 text-white text-[11px] font-black uppercase tracking-widest rounded-3xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-600/20 active:scale-95 flex items-center gap-2"
                >
                  <Save size={18} />
            ...
            <div className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="space-y-8">
                <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 flex items-center justify-between">
                  ...
                  <div className="w-14 h-8 bg-emerald-500 rounded-full relative p-1 transition-all cursor-pointer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                   <div className="space-y-3">
                    ...
                    <input type="password" placeholder="••••••••" className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-3xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all" />
                  </div>
                   <div className="space-y-3">
            ...
            <div className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 group hover:border-indigo-200 transition-all">
                    <div className="space-y-1">
                    ...
                    <div className={`w-14 h-8 ${item.active ? 'bg-indigo-600' : 'bg-slate-300'} rounded-full relative p-1 transition-all cursor-pointer`}>
          ...
          {activeTab === 'Integrations' && (
            <div className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
               <div className="flex items-center justify-between">
                ...
                <button className="px-8 py-4 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-indigo-600/20 active:scale-95 flex items-center gap-2">
                  <Zap size={16} />
                  Generate New Key
                </button>
              </div>
              ...
              <div className="p-8 bg-slate-900 rounded-[3rem] text-white space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setShowToken(!showToken)} className="text-[10px] font-black text-indigo-400 uppercase tracking-widest hover:text-indigo-300">
                  ...
                  <div className="relative group">
                    <input 
                      ...
                      className="w-full px-8 py-5 bg-white/5 border border-white/10 rounded-3xl text-sm font-black text-indigo-400 focus:outline-none"
                    />
